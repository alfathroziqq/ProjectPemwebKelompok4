...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="clearfix">
            ...
            <ul class="pagination">
                <li class="page-item {{ $riwayatPerubahanRumahs->currentPage() == 1 ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $riwayatPerubahanRumahs->url(1) }}">First</a>
                </li>
                <li class="page-item {{ $riwayatPerubahanRumahs->currentPage() <= 1 ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $riwayatPerubahanRumahs->previousPageUrl() }}">Previous</a>
                </li>
                @for ($i = 1; $i <= $riwayatPerubahanRumahs->lastPage(); $i++)
                    <li class="page-item {{ $riwayatPerubahanRumahs->currentPage() == $i ? ' active' : '' }}">
                        <a class="page-link" href="{{ $riwayatPerubahanRumahs->url($i) }}">{{ $i }}</a>
                    </li>
                @endfor
                <li
                    class="page-item {{ $riwayatPerubahanRumahs->currentPage() == $riwayatPerubahanRumahs->lastPage() ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $riwayatPerubahanRumahs->nextPageUrl() }}">Next</a>
                </li>
                <li
                    class="page-item {{ $riwayatPerubahanRumahs->currentPage() == $riwayatPerubahanRumahs->lastPage() ? 'disabled' : '' }}">
                    <a class="page-link"
                        href="{{ $riwayatPerubahanRumahs->url($riwayatPerubahanRumahs->lastPage()) }}">Last</a>
                </li>
            </ul>
        </div>
    </div>
